...
x_train, y_train, x_test, y_test, class_names, mean_c, std_c = load_dishes_data(root_dir, img_size=(32, 32))
...
model = Dishes_CNN(num_classes, img_size=(32, 32))
...
checkpoint_path = os.path.join(os.path.dirname(__file__), 'checkpoints', 'dishes_cnn_cuda_checkpoint.pkl')
start_epoch = 0
...
plt.grid(True)
plt.tight_layout()
plt.savefig('dishes_cnn_training.png', dpi=150, bbox_inches='tight')
plt.show()
print("训练完成！图表已保存为 'dishes_cnn_training.png'")
